...
OUTPUT = Path("results/raw/korobeiniki_test.wav")
...
#
# Pitch and rhythm follow the traditional vocal melody rather than
# a specific Tetris arrangement.
# ============================================================
...
# The traditional transcription repeats the second four-bar phrase.
C_SECTION = [
    # Bar 5
    ("F5", 1.5, 1.00),
    ("G5", 0.5, 0.90),
