...
BLIND_RESULT_DIR="$RESULTS_DIR/blind"
BLIND_DIR="$BLIND_RESULT_DIR/temp"
DEPLOY_DIR="$BLIND_RESULT_DIR/blind_deploy"

TIMESTAMP="$(date '+%Y-%m-%d_%H-%M-%S')"
INTEGRITY_DIR="$BLIND_RESULT_DIR/blind_$TIMESTAMP"
